...
async function createconfig() {
  ...
  const config = {
    ...
    title: "SentiBot: Gen-AI Powered News Scraper and Sentiment Analyzer",
      ...
      [
        ...
        ({
          docs: {
            ...
            editUrl:
              "https://github.com/ibm-client-engineering/solution-sentibot/tree/main/packages/create-docusaurus/templates/shared/",
          },
          theme: {
          ...
          blog: {
            ...
            editUrl: ({ locale, blogDirPath, blogPath, permalink }) =>
              "https://github.com/ibm-client-engineering/solution-sentibot/edit/main/${blogDirPath}/${blogPath}",
